...
{for(var i = 0, len = gdjs.room_322_32monitorCode.GDtextBoxObjects2.length ;i < len;++i) {
    gdjs.room_322_32monitorCode.GDtextBoxObjects2[i].setString("PC unlocked. Goto next screen for learnings");
}
}}
...
gdjs.room_322_32monitorCode.mapOfGDgdjs_46room_95322_9532monitorCode_46GDRightObjects1Objects = Hashtable.newFrom({"Right": gdjs.room_322_32monitorCode.GDRightObjects1});
...
gdjs.copyArray(runtimeScene.getObjects("Right"), gdjs.room_322_32monitorCode.GDRightObjects1);

gdjs.room_322_32monitorCode.condition0IsTrue_0.val = false;
gdjs.room_322_32monitorCode.condition1IsTrue_0.val = false;
{
gdjs.room_322_32monitorCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.room_322_32monitorCode.mapOfGDgdjs_46room_95322_9532monitorCode_46GDRightObjects1Objects, runtimeScene, true, false);
}if ( gdjs.room_322_32monitorCode.condition0IsTrue_0.val ) {
{
gdjs.room_322_32monitorCode.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
}}
if (gdjs.room_322_32monitorCode.condition1IsTrue_0.val) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "room 3 learnings", false);
}}
